...
public class DessertActivity extends AppCompatActivity {
    ...
    public void initializeComponents(){
        ...
        dessertPlatesRecyclerView = (RecyclerView) findViewById(R.id.dessert_view);
        ...
        btnAvancar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent drinkActivity = new Intent(DessertActivity.this, DrinkActivity.class);
                drinkActivity.putExtra("pedido", pedido);
